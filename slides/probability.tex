...
\begin{frame}
\begin{center}
  \includegraphics[page=1,width=0.65\textwidth]{../libros/bayes/distributions.pdf}
  \end{center}
\end{frame}

\begin{frame}
\begin{center}
  \includegraphics[page=2,width=0.65\textwidth]{../libros/bayes/distributions.pdf}
  \end{center}
\end{frame}

\begin{frame}
\begin{center}
  \includegraphics[page=3,width=0.65\textwidth]{../libros/bayes/distributions.pdf}
  \end{center}
\end{frame}
